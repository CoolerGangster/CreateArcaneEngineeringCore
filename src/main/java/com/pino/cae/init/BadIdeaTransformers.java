...
public class BadIdeaTransformers {
        ...
        return encasedBase(b, drop).addLayer(() -> RenderType::cutoutMipped)
                ...
                .blockstate((c, p) -> axisBlock(c, p, blockState -> {
                    ...
                    return p.models()
                            ...
                            .texture("casing", Cae.asResource("block/" + casing + "_casing"))
                            .texture("particle", Cae.asResource("block/" + casing + "_casing"))
                            .texture("4", Cae.asResource("block/" + gearbox))
                            .texture("1", Cae.asResource("block/" + casing + "_casing"))
                            .texture("side", Cae.asResource("block/" + casing + encasedSuffix));
                }, false))
                .item()
