...
public class CrimsiteCatalyst extends Block {
    ...
    public CrimsiteCatalyst(Properties p_49795_) {
        super(p_49795_);
    }
    ...
    public static void tickEvent(TickEvent.WorldTickEvent w) {
        ...
        schedule.forEach(((blockPos, tuple) -> {
            ...
            if (tuple.getA() <= 0) {
                ...
                tuple.getB().setBlock(blockPos, GeodeShit.Crimsite.defaultBlockState(), 3);
                return;
            }
